...
## Project Structure
    ...
    ├── testapiautocatalog_105557  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_105557`
...
2. Clone this repo and `cd testapiautocatalog_105557`
